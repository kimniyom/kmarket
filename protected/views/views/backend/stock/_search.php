...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'imputnumber'); ?>
		<?php echo $form->textField($model,'imputnumber'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'date_expire'); ?>
		<?php echo $form->textField($model,'date_expire'); ?>
	</div>
