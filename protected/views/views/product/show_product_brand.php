...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var brands = "<?php echo $brands['id']; ?>";
        $('#results').load("<?php echo Yii::app()->createUrl('frontend/product/pagesbrands') ?>", {'page': track_click, brands: brands}, function () {
            track_click++;
        ...
        $(".load_more").click(function (e) { //user clicks on button
            ...
            if (track_click <= total_pages) //make sure user clicks are still less than total pages
            {
                ...
                $.post('<?php echo Yii::app()->createUrl('frontend/product/pagesbrands') ?>',
                        {'page': track_click, brands: brands},
                        function (data) {
                            if (data == 0) {
