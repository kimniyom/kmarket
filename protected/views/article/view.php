            ...
            <div class="row">
                <div class="col-md-9">
                    <article class="blog-detail">
                        <h3 class="title-blog-detail font-THK" style="font-size: 34px; color: #000000;"><?php echo $result['title'] ?></h3>
                        ...
                        <div class="content">
                            <img class="feature-image" src="<?= Yii::app()->baseUrl; ?>/uploads/article/<?php echo $result['images'] ?>" alt="feature-image">
                            <div id="box-article">
