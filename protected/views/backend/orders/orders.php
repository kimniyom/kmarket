                ...
                <div id="collapse<?php echo $rs['id'] ?>" class="panel-collapse collapse <?php echo $panelCol ?>" role="tabpanel" aria-labelledby="heading<?php echo $rs['id'] ?>">
                    <div class="panel-body">
                        <div class="well">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3" style=" text-align: center;">
                                    ...
                                    <?php } else { ?>
                                        <div style=" color: #cc3300; text-align: center; font-weight: bold;">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td colspan="6" style=" text-align: right;">
                                    <h4 class="pull-left">ค่าขนส่ง</h4>
                                    <h4 class="pull-right">
                                        <font style=" color: red;"><?php echo $rs['transportprice']; ?></font> บาท
                                    </h4>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6" style=" text-align: right; font-weight: bold;">
                                    ...
                                    <h4 class="pull-right">
                                        <font style=" color: red;"><?php echo ($total_price + $rs['transportprice']); ?></font> บาท
                                    </h4>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class=" panel-footer">
                        <div class="row">
                            <div class="col-md-9 col-lg-9 col-sm-7 col-xs-6">
