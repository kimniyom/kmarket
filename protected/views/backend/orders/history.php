...
<div class="panel panel-default">
    <div class="panel-heading"><h3 style=" margin-top: 5px;">ข้อมูลการสั่งซื้อ</h3></div>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-3">
                ...
                <select class="form-control" id="status">
                    ...
                    <option value="4">ยืนยันรายการ / รอจัดส่ง</option>
                    <option value="3">ยกเลิกรายการ</option>
                    <option value="5">จัดส่งสินค้าแล้ว</option>
                </select>
            </div>
            <div class="col-md-3 col-lg-3">
                <div class="col-md-10">
