...
<html>
    ...
    <body class="animsition animsition" style="background: #f2f2f2;">
        ...
        <footer class="footer-style-1" style=" border-top: #eeeeee solid 1px; background: #171721;">
            <div class="container">
                <div class="row">
                    <div class="footer-style-1-inner">
                        <div class="widget-footer widget-text col-first col-small">

                            <img class="logo-footer" src="<?php echo Yii::app()->baseUrl; ?>/images/logo-headphone.png" alt="headphoneguru" />
