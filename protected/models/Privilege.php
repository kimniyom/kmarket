...
class Privilege extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('shop, setting, product, article, contact, log, user,report', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, shop, setting, product, article, contact, log, report ,user', 'safe', 'on'=>'search'),
		);
	}
