...
--
-- Host: localhost:3306
-- Generation Time: Apr 23, 2020 at 10:30 PM
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ที่อยู่สมาชิก';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางอำเภอ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บบทความ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บข้อมูลธนาคาร';
...
CREATE TABLE banner (
  banner_id int(2) NOT NULL COMMENT 'รหัส',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='หมวดสินค้า';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='บริษัทขนส่ง';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บข้อมูลติดต่อ';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บข้อมูล';
...
INSERT IGNORE INTO logorders (id, admin_id, `log`, order_id, `date`, `status`, `user`) VALUES
(7, NULL, 'user ID 34 CheckOut 1', 1, '2020-04-21 10:56:08', 1, 34),
(8, 1, 'user ID 1 Confirm Order 1', 1, '2020-04-21 11:44:05', 4, NULL),
(9, 1, 'ยืนยันการจัดส่ง  Confirm Order 1 tracking number ', 1, '2020-04-21 11:44:29', 5, NULL),
(10, NULL, 'user ID 34 CheckOut 2', 2, '2020-04-21 14:37:25', 1, 34),
(11, 1, 'user ID 1 Confirm Order 2', 2, '2020-04-21 14:38:07', 4, NULL),
(12, 1, 'ยืนยันการจัดส่ง  Confirm Order 2 tracking number ', 2, '2020-04-21 14:40:18', 5, NULL),
(13, NULL, 'user ID 34 CheckOut 3', 3, '2020-04-21 14:42:47', 1, 34),
(14, 1, 'user ID 1 Confirm Order 3', 3, '2020-04-21 14:43:07', 4, NULL),
(15, 1, 'ยืนยันการจัดส่ง  Confirm Order 3 tracking number ', 3, '2020-04-21 14:43:35', 5, NULL),
(16, NULL, 'user ID 34 CheckOut 4', 4, '2020-04-21 14:43:54', 1, 34),
(17, 1, 'user ID 1 Confirm Order 4', 4, '2020-04-21 14:44:15', 4, NULL),
(18, 1, 'ยืนยันการจัดส่ง  Confirm Order 4 tracking number ', 4, '2020-04-21 14:44:48', 5, NULL),
(19, NULL, 'user ID 37 CheckOut 5', 5, '2020-04-21 14:46:45', 1, 37),
(20, NULL, 'user ID 37 CheckOut 6', 6, '2020-04-21 14:53:33', 1, 37),
(21, NULL, 'user ID 27 CheckOut 7', 7, '2020-04-21 19:09:53', 1, 27),
(22, NULL, 'user ID 34 CheckOut 8', 8, '2020-04-23 08:11:00', 1, 34),
(23, 1, 'user ID 1 Confirm Order 5', 5, '2020-04-23 08:11:32', 4, NULL),
(24, 1, 'user ID 1 Confirm Order 6', 6, '2020-04-23 08:11:43', 4, NULL),
(25, 1, 'user ID 1 Confirm Order 8', 8, '2020-04-23 08:12:39', 4, NULL),
(26, NULL, 'user ID 40 CheckOut 9', 9, '2020-04-23 10:14:22', 1, 40),
(27, NULL, 'user ID 40 CheckOut 10', 10, '2020-04-23 10:16:06', 1, 40),
(28, 1, 'user ID 1 Confirm Order 9', 9, '2020-04-23 10:17:20', 4, NULL),
(29, 1, 'user ID 1 Confirm Order 10', 10, '2020-04-23 10:18:40', 4, NULL),
(30, 1, 'ยืนยันการจัดส่ง  Confirm Order 8 tracking number ', 8, '2020-04-23 10:23:29', 5, NULL),
(31, 1, 'ยืนยันการจัดส่ง  Confirm Order 9 tracking number ', 9, '2020-04-23 10:23:44', 5, NULL),
(32, 1, 'ยืนยันการจัดส่ง  Confirm Order 10 tracking number ', 10, '2020-04-23 10:24:01', 5, NULL),
(33, NULL, 'user ID 40 CheckOut 11', 11, '2020-04-23 10:25:41', 1, 40),
(34, 1, 'user ID 1 Confirm Order 11', 11, '2020-04-23 10:30:25', 4, NULL),
(35, 1, 'ยืนยันการจัดส่ง  Confirm Order 11 tracking number ', 11, '2020-04-23 10:31:12', 5, NULL),
(36, NULL, 'user ID 43 CheckOut 12', 12, '2020-04-23 11:37:46', 1, 43),
(37, 1, 'user ID 1 Confirm Order 12', 12, '2020-04-23 11:39:15', 4, NULL),
(38, 1, 'ยืนยันการจัดส่ง  Confirm Order 12 tracking number ', 12, '2020-04-23 11:39:52', 5, NULL),
(39, NULL, 'user ID 43 CheckOut 13', 13, '2020-04-23 13:12:01', 1, 43);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='เก็บข้อมูลการจัดการสินค้า';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บประเภทการติดต่อ SocialApp';
...
CREATE TABLE news (
  id int(5) NOT NULL COMMENT 'รหัส',
...
CREATE TABLE notify (
  notify_id int(7) NOT NULL COMMENT 'รหัส',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บช่องทางการชำระเงิน';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตรางเก็บช่วงระยะเวลาจองสินค้า';
...
CREATE TABLE popupalert (
  id int(3) NOT NULL,
  detail longtext
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ช่องทางแจ้งเตือนการชำระเงิน';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บรูปภาพสินค้า';
...
CREATE TABLE product_type (
  ...
  category int(10) DEFAULT NULL COMMENT 'category'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางประเภทสินค้า';
...
(19, 'P20200419211236', NULL, 2, '2020-04-19', '2020-10-31', NULL, 3, '20200419211759'),
...
CREATE TABLE tambon (
  ...
  changwat_id int(11) NOT NULL DEFAULT '0',
  geo_id int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางตำบล';
...
CREATE TABLE viewproduct (
  ...
  product_id varchar(20) DEFAULT NULL,
  dupdate timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='เก้บประวัติการเข้าดูสินค้า';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บชื่อระบบงาน';
...
--
-- Indexes for table ampur
--
ALTER TABLE ampur
  ADD PRIMARY KEY (ampur_id);
...
--
-- Indexes for table articlegallery
--
ALTER TABLE articlegallery
  ADD PRIMARY KEY (id);

--
-- Indexes for table backendgroupmenu
--
ALTER TABLE backendgroupmenu
  ADD PRIMARY KEY (id);

--
-- Indexes for table backendmenu
--
ALTER TABLE backendmenu
  ADD PRIMARY KEY (id),
  ADD KEY backendgroupmenu (groupmenu) USING BTREE;
...
--
-- Indexes for table changwat
--
ALTER TABLE changwat
  ADD PRIMARY KEY (changwat_id);
...
ALTER TABLE `comment`
  ADD PRIMARY KEY (id),
  ADD KEY proid (product_id) USING BTREE,
...
--
-- Indexes for table logorders
--
ALTER TABLE logorders
  ADD PRIMARY KEY (id);

--
-- Indexes for table logproduct
--
ALTER TABLE logproduct
  ADD PRIMARY KEY (id);

--
-- Indexes for table loguserlogin
--
ALTER TABLE loguserlogin
  ADD PRIMARY KEY (id);

--
-- Indexes for table massocial
--
ALTER TABLE massocial
  ADD PRIMARY KEY (id);

--
-- Indexes for table masuser
--
ALTER TABLE masuser
  ADD PRIMARY KEY (id),
...
ALTER TABLE notify
  ...
  ADD KEY oederid (order_id) USING BTREE;
...
--
-- Indexes for table pername
--
ALTER TABLE pername
  ADD PRIMARY KEY (oid);

--
-- Indexes for table popupalert
--
ALTER TABLE popupalert
  ADD PRIMARY KEY (id);
...
--
-- Indexes for table viewproduct
--
ALTER TABLE viewproduct
  ADD PRIMARY KEY (id);
...
--
-- AUTO_INCREMENT for table ampur
--
ALTER TABLE ampur
  MODIFY ampur_id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=999;
...
--
-- AUTO_INCREMENT for table articlegallery
--
ALTER TABLE articlegallery
  MODIFY id int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table backendgroupmenu
--
ALTER TABLE backendgroupmenu
  MODIFY id int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table backendmenu
--
ALTER TABLE backendmenu
  MODIFY id int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE banner
  MODIFY banner_id int(2) NOT NULL AUTO_INCREMENT COMMENT 'รหัส';
...
--
-- AUTO_INCREMENT for table changwat
--
ALTER TABLE changwat
  MODIFY changwat_id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
-- AUTO_INCREMENT for table logorders
--
ALTER TABLE logorders
  MODIFY id int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table logproduct
--
ALTER TABLE logproduct
  MODIFY id int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table loguserlogin
--
ALTER TABLE loguserlogin
  MODIFY id int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;

--
-- AUTO_INCREMENT for table massocial
--
ALTER TABLE massocial
  MODIFY id int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table masuser
--
ALTER TABLE masuser
  MODIFY id int(7) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=44;
...
--
ALTER TABLE news
  MODIFY id int(5) NOT NULL AUTO_INCREMENT COMMENT 'รหัส';

--
-- AUTO_INCREMENT for table notify
--
ALTER TABLE notify
  MODIFY notify_id int(7) NOT NULL AUTO_INCREMENT COMMENT 'รหัส';
...
--
-- AUTO_INCREMENT for table popupalert
--
ALTER TABLE popupalert
  MODIFY id int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE product_type
  MODIFY id int(5) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=43;
...
--
ALTER TABLE tambon
  MODIFY tambon_id int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8861;
...
--
-- AUTO_INCREMENT for table viewproduct
--
ALTER TABLE viewproduct
  MODIFY id int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=668;
