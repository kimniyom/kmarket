...
--
-- Host: localhost:3306
-- Generation Time: Apr 16, 2020 at 09:53 PM
...
--
CREATE DATABASE IF NOT EXISTS `cp916706_kmarket` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cp916706_kmarket`;
...
(1, '<p>&nbsp;</p>\n\n<p><strong>1. บทนำนโยบายความเป็นส่วนตัว</strong></p>\n\n<p>1.1 เราดูแลความเป็นส่วนตัวของท่านอย่างจริงจัง เราให้คำมั่นว่าจะปฏิบัติตามกฎหมายคุ้มครองข้อมูลส่วนบุคคลที่มีผลบังคับใช้ทั้งหมด&nbsp;</p>\n\n<p>1.2 ในระหว่างการให้บริการแก่ท่านหรือการเข้าถึงแพลตฟอร์ม&nbsp;เราจะเก็บรวบรวม ใช้ เปิดเผย เก็บรักษา และ/หรือประมวลผลข้อมูล โดยรวมถึงข้อมูลส่วนบุคคลของท่าน&nbsp;</p>\n\n<p>1.3 นโยบายความเป็นส่วนตัวฉบับนี้มีขึ้นเพื่อให้ท่านทราบเกี่ยวกับวิธีการที่เราเก็บรวบรวม ใช้ เปิดเผย เก็บรักษาและ/หรือประมวลผลข้อมูลที่เราเก็บรวบรวมและได้รับระหว่างการให้บริการหรือการเข้าถึงแพลตฟอร์มของท่าน ผู้ซึ่งเป็นลูกค้าของเรา เราจะเก็บรวบรวม ใช้ เปิดเผย เก็บรักษาและ/หรือประมวลผลข้อมูลส่วนบุคคลของท่านตามนโยบายความเป็นส่วนตัวนี้เท่านั้น</p>\n\n<p>1.4 ท่านจำเป็นจะต้องอ่านนโยบายความเป็นส่วนตัวนี้รวมถึงประกาศแจ้งอื่นใดที่เราอาจมีขึ้นเฉพาะกาล ขณะที่เราทำการเก็บรวบรวม ใช้ เปิดเผยและ/หรือประมวลผลข้อมูลส่วนบุคคลเกี่ยวกับท่าน เพื่อให้ท่านได้รับรู้ว่าเราใช้ข้อมูลส่วนบุคคลของท่านอย่างไรและเพื่ออะไร&nbsp;</p>\n\n<p>1.5 เมื่อคลิกหรือเลือกปุ่ม &ldquo;ลงทะเบียน&rdquo; &ldquo;ข้าพเจ้าตกลงยอมรับนโยบายความเป็นส่วนตัว&rdquo; &ldquo;ข้าพเจ้าตกลงและยินยอมให้เก็บรวบรวม ใช้ เปิดเผย เก็บรักษาและ/หรือประมวลผลซึ่งข้อมูลส่วนบุคคลของข้าพเจ้าเพื่อวัตถุประสงค์ที่ระบุไว้ในนี้และภายใต้ข้อกำหนดของนโยบายความเป็นส่วนตัว&rdquo; หรือข้อความคล้ายคลึงกันที่มีอยู่ในหน้าลงทะเบียน&nbsp;ท่านรับทราบว่าท่านได้รับแจ้งและเข้าใจนโยบายความเป็นส่วนตัวฉบับนี้และท่านยังได้ตกลงและยินยอมให้เก็บรวบรวม ใช้ เปิดเผย และ/หรือประมวลผลข้อมูลส่วนบุคคลของท่านตามที่ได้อธิบายและอยู่ภายใต้ข้อกำหนดนี้&nbsp;</p>\n\n<p>1.6 เราอาจแก้ไขนโยบายความเป็นส่วนตัวนี้ให้ทันสมัยเป็นครั้งคราว โดยการเปลี่ยนแปลงใด ๆ ในนโยบายความเป็นส่วนตัวฉบับนี้ในอนาคตจะถูกประกาศให้ทราบไว้ในเพจนี้และ เราจะแจ้งให้ท่านทราบหากเป็นการเปลี่ยนแปลงอย่างมีนัยยะสำคัญ (ตามความเหมาะสม และ/หรือได้รับอนุญาตภายใต้กฎหมายท้องถิ่น) และเมื่อท่านยังคงใช้บริการ เข้าถึงแพลตฟอร์มหรือใช้บริการใด ๆ รวมถึงทำคำสั่งซื้อบนแพลตฟอร์มต่อไปหลังจากนั้น ให้ถือว่าท่านได้รับทราบและยอมรับการเปลี่ยนแปลงนโยบายความเป็นส่วนตัวฉบับนี้โดยเราแล้ว กรุณาตรวจสอบนโยบายความเป็นส่วนตัวเป็นประจำเพื่อให้ทราบถึงการปรับเปลี่ยนให้ทันสมัยหรือการแก้ไขใด ๆ กับนโยบายความเป็นส่วนตัวนี้</p>\n\n<p>1.7 นโยบายความเป็นส่วนตัวฉบับนี้มีผลบังคับใช้ร่วมกับประกาศ ข้อความสัญญาและข้อความความยินยอมอื่น ๆ ที่เกี่ยวข้องกับการการเก็บรวบรวม เก็บรักษา ใช้และ/หรือการประมวลผลข้อมูลส่วนบุคคลโดยเราและไม่มีจุดประสงค์ในการแทนที่ประกาศ ข้อความสัญญาและข้อความยินยอมดังกล่าวเว้นแต่ว่าเราระบุไว้เป็นอย่างอื่นโดยชัดแจ้ง&nbsp;</p>\n\n<p>1.8 ท่านสามารถเข้าใช้แพลตฟอร์มและสำรวจแพลตฟอร์มได้โดยไม่ต้องให้ข้อมูลส่วนบุคคล อย่างไรก็ตามท่านจำเป็นต้องลงทะเบียนบัญชีผู้ใช้หากท่านต้องการใช้บริการ</p>\n\n<p>&nbsp;</p>\n\n<p><strong>2. ข้อมูลส่วนบุคคลที่เราเก็บรวบรวมจากท่าน</strong></p>\n\n<p>2.1 ข้อมูลส่วนบุคคลหมายถึง ข้อมูลใด ๆ ไม่ว่าจะถูกบันทึกในรูปแบบเอกสารหรือไม่ ซึ่งมีการแสดงข้อมูลระบุตัวตน หรือทำให้ผู้ที่ถือข้อมูลนั้นสามารถยืนยันตัวบุคคลได้โดยตรง หรืออย่างสมเหตุสมผล หรือเมื่อนำไปรวมกับข้อมูลอื่น ๆ จะทำให้สามารถระบุตัวตนของบุคคลได้อย่างแน่นอนไม่ว่าทางตรงหรือทางอ้อม</p>\n\n<p>&nbsp;</p>\n\n<p>2.2 ระหว่างระยะเวลาที่ท่านใช้แพลตฟอร์มและใช้บริการจากเรา เราอาจเก็บรวบรวมข้อมูลส่วนบุคคลจากท่านซึ่งรวมถึงแต่ไม่จำกัดเพียง&nbsp;</p>\n\n<p>(ก) ข้อมูลระบุตัวตน เช่น ชื่อ รูปโปรไฟล์</p>\n\n<p>(ข) ข้อมูลติดต่อ เช่น ที่อยู่สำหรับส่งพัสดุ ที่อยู่อีเมลและหมายเลขโทรศัพท์</p>\n\n<p>(ค) ข้อมูลบัญชี เช่น หลักฐานการโอนเงินธนาคารและรายละเอียดการชำระเงิน&nbsp;</p>\n\n<p>(ง) ข้อมูลการทำธุรกรรม เช่น รายละเอียดเกี่ยวกับคำสั่งซื้อและการชำระเงินถึงท่านและจากท่าน และรายละเอียดอื่นของสินค้าและบริการที่ท่านได้ซื้อหรือได้รับผ่านแพลตฟอร์ม&nbsp;</p>\n\n<p>(จ) ข้อมูลทางเทคนิค เช่น ที่อยู่ไอพี (IP address) ข้อมูลการเข้าใช้</p>\n\n<p>(ฉ) ข้อมูลโปรไฟล์ เช่น ชื่อผู้ใช้และรหัสผ่านของท่าน การซื้อหรือคำสั่งซื้อของท่าน ความสนใจของท่าน สิ่งที่ท่านสนใจ</p>\n\n<p>(ช) ข้อมูลการใช้ เช่น ข้อมูลว่าท่านใช้แพลตฟอร์ม สินค้าและการบริการอย่างไร หรือดูเนื้อหาใดบนแพลตฟอร์ม&nbsp;</p>\n\n<p>&nbsp;</p>\n\n<p>2.3 ระหว่างระยะเวลาที่ท่านใช้แพลตฟอร์มและใช้บริการจากเรา เราอาจได้รับข้อมูลส่วนบุคคลจากท่านในสถานการณ์ดังต่อไปนี้&nbsp;</p>\n\n<p>(ก) เมื่อท่านได้สร้างบัญชีผู้ใช้กับเรา&nbsp;</p>\n\n<p>(ข) เมื่อท่านได้สมัครบริการใด ๆ หรือซื้อสินค้าใดที่มีอยู่บนแพลตฟอร์ม&nbsp;</p>\n\n<p>(ค) เมื่อท่านได้ใช้ฟีเจอร์หรือฟังก์ชั่นการทำงานใดที่มีอยู่บนแพลตฟอร์มหรือการบริการ</p>\n\n<p>(ง) เมื่อท่านได้บันทึกเนื้อหาที่สร้างขึ้นโดยผู้ใช้ใด ๆ ที่อัพโหลดอยู่บนแพลตฟอร์ม&nbsp;</p>\n\n<p>(จ) เมื่อท่านได้เข้าสู่ระบบจากบัญชีผู้ใช้ของท่านบนแพลตฟอร์มหรือสื่อสารกับเราผ่านบริการหรือแอปพลิเคชันภายนอก เช่น เฟซบุ๊กหรือกูเกิ้ล&nbsp;</p>\n\n<p>(ฉ) เมื่อท่านได้ติดต่อกับเราทางออฟไลน์</p>\n\n<p>2.4 ระหว่างระยะเวลาที่ท่านใช้แพลตฟอร์มและและใช้บริการ ท่านได้ให้ความยินยอมอย่างชัดแจ้งในการโอนข้อมูลส่วนบุคคลของท่านจากบุคคลภายนอกมายัง Application เพื่อวัตถุประสงค์ที่ระบุไว้ในนโยบายความเป็นส่วนตัวฉบับนี้หรือข้อกำหนดอื่นใด&nbsp;</p>\n\n<p>2.5 ท่านต้องส่งข้อมูลส่วนบุคคลซึ่งถูกต้องและไม่ก่อให้เกิดความเข้าใจผิดเท่านั้น และท่านต้องหมั่นทำให้ข้อมูลดังกล่าวเป็นปัจจุบันและแจ้งให้เราทราบหากมีการเปลี่ยนแปลงข้อมูลส่วนบุคคลใด ๆ ที่ท่านได้ให้ไว้กับเรา เรามีสิทธิที่จะร้องขอเอกสารยืนยันความถูกต้องของข้อมูลส่วนบุคคลที่ท่านได้เคยให้ไว้ เพื่อเป็นส่วนหนึ่งในขั้นตอนการตรวจสอบลูกค้าของเรา&nbsp;</p>\n\n<p>2.6 เราสามารถเก็บรวบรวมข้อมูลส่วนบุคคลของท่านได้ต่อเมี่อท่านสมัครใจที่จะส่งข้อมูลส่วนบุคคลให้กับเราหรือตามที่ระบุไว้เป็นอย่างอื่นภายใต้นโยบายความเป็นส่วนตัวนี้เท่านั้น อย่างไรก็ตามหากท่านเลือกที่จะไม่ให้ข้อมูลส่วนบุคคลของท่านแก่เราหรือท่านได้ถอนความยินยอมของท่านในการให้เราใช้ข้อมูลส่วนบุคคลของท่านในภายหลัง เราอาจจะไม่สามารถให้บริการแก่ท่านหรืออนุญาตให้ท่านเข้าถึงแพลตฟอร์มต่อไปได้</p>\n\n<p>2.7 ท่านสามารถเข้าถึงและแก้ไขข้อมูลที่ท่านเคยส่งให้เราให้เป็นปัจจุบันได้ไม่ว่าในเวลาใดตามที่ระบุไว้ด้านล่าง</p>\n\n<p>2.8 หากท่านให้ข้อมูลส่วนบุคคลของบุคคลภายนอกใดแก่เรา ท่านรับรองและรับประกันว่าท่านได้รับความยินยอม หนังสืออนุญาต และการอนุญาตตามที่จำเป็นจากบุคคลภายนอกดังกล่าวให้นำมาเปิดเผย และโอนข้อมูลส่วนบุคคลของเขาหรือเธอให้แก่เรา และให้เราเก็บรวบรวม เก็บรักษา ใช้และเปิดเผยข้อมูลดังกล่าวตามนโยบายความเป็นส่วนตัวฉบับนี้&nbsp;</p>\n\n<p>2.9 หากท่านสมัครเป็นผู้ใช้แพลตฟอร์มของเราโดยใช้บัญชีเครือข่ายสังคมใดของท่าน หรือเชื่อมต่อบัญชีของท่านกับบัญชีเครือข่ายสังคมของท่านหรือใช้ฟีเจอร์อื่นของเครือข่ายสังคม เราจะสามารถเข้าถึงข้อมูลส่วนบุคคลเกี่ยวกับท่านซึ่งท่านได้สมัครใจให้ไว้แก่ผู้ให้บริการเครือข่ายสังคมตามนโยบายของผู้ให้บริการดังกล่าวและเราจะจัดการข้อมูลส่วนบุคคลของท่านตามนโยบายความเป็นส่วนตัวฉบับนี้</p>\n\n<p>&nbsp;</p>\n\n<p><strong>3. การใช้และเปิดเผยข้อมูลส่วนบุคคล</strong></p>\n\n<p>3.1 ข้อมูลส่วนบุคคลที่เราเก็บรวบรวมจากท่านหรือผ่านบุคคลภายนอกอาจถูกใช้หรือเผยแพร่หรือโอนให้แก่บุคคลภายนอก (รวมไปถึงบริษัทที่เกี่ยวข้อง ผู้ให้บริการที่เป็นบุคคลภายนอกและผู้ให้บริการของหน่วยงานดังกล่าวและบริษัทที่เกี่ยวข้อง บริษัทที่ตั้งอยู่ทั้งในและนอกประเทศของท่าน ผู้ขายและผู้ใช้อื่น) สำหรับวัตถุประสงค์เฉพาะเรื่องซึ่งรวมถึงแต่ไม่จำกัดเพียงวัตถุประสงค์ดังต่อไปนี้&nbsp;</p>\n\n<p>(ก) เพื่ออำนวยความสะดวกในการใข้บริการหรือการเข้าถึงแพลตฟอร์มของท่าน</p>\n\n<p>(ข) เพื่อตอบซึ่งข้อซักถาม ผลตอบรับ ข้อเรียกร้องหรือข้อโต้แย้งของท่าน ไม่ว่าโดยตรงหรือผ่านตัวแทนฝ่ายบริการลูกค้า</p>\n\n<p>(ค) เพื่อประมวลผลคำสั่งที่ท่านส่งเข้ามาผ่านแพลตฟอร์ม</p>\n\n<p>(ง) เพื่อส่งสินค้าที่ท่านได้ซื้อผ่านแพลตฟอร์ม เราอาจส่งข้อมูลส่วนบุคคลต่อไปยังบุคคลภายนอกเพื่อที่จะดำเนินการส่งสินค้าให้แก่ท่าน (เช่น ส่งให้ผู้ขนส่งสินค้าของเรา)&nbsp;</p>\n\n<p>(จ) เพื่อแจ้งให้ท่านทราบสถานะการขนส่งสินค้าทั้งที่ขายผ่านแพลตฟอร์มโดยเราและผู้ขายบุคคลภายนอก และเพื่อวัตถุประสงค์ในการช่วยเหลือลูกค้า&nbsp;</p>\n\n<p>(ฉ) เพื่อเปรียบเทียบข้อมูลและตรวจสอบกับบุคคลภายนอกเพื่อที่จะยืนยันว่าข้อมูลดังกล่าวนั้นถูกต้อง</p>\n\n<p>(ช) เพื่อยืนยันตัวตนของท่านสำหรับวัตถุประสงค์ในการตรวจจับการทุจริต</p>\n\n<p>(ซ) เพื่ออำนวยความสะดวกในการนำสินค้าต้องห้ามและสินค้าควบคุมออกจากแพลตฟอร์ม&nbsp;</p>\n\n<p>(ฌ) เพื่อจัดการบัญชีของท่านที่มีกับเรา (หากมี)&nbsp;</p>\n\n<p>(ญ) เพื่อตรวจสอบและดำเนินธุรกรรมทางการเงินที่เกี่ยวข้องกับการชำระเงินออนไลน์ของท่าน (หากมี)</p>\n\n<p>(ฎ) เพื่อตรวจสอบการดาวน์โหลดข้อมูลจากแพลตฟอร์ม&nbsp;</p>\n\n<p>(ฏ) เพื่อปรับปรุงรูปแบบหรือเนื้อหาของเพจของแพลตฟอร์มและปรับแต่งเพจนั้นให้เหมาะกับผู้ใช้&nbsp;</p>\n\n<p>(ฐ) เพื่อระบุตัวตนผู้เยี่ยมชมบนแพลตฟอร์ม&nbsp;</p>\n\n<p>(ฑ) เพื่อดำเนินการค้นคว้าวิจัยเกี่ยวกับสถิติและพฤติกรรมของผู้ใช้&nbsp;</p>\n\n<p>(ฒ) เพื่อให้ข้อมูลที่เราเห็นว่าอาจมีประโยชน์สำหรับท่านหรือที่ท่านร้องขอจากเรา รวมถึงข้อมูลที่เกี่ยวข้องกับสินค้าและบริการ ของเราหรือผู้ขายบุคคลภายนอก ซึ่งท่านได้แจ้งแล้วว่าท่านไม่คัดค้านที่จะได้รับการติดต่อเพื่อวัตถุประสงค์ดังกล่าว</p>\n\n<p>(ณ) เพื่อแสดงชื่อ ชื่อผู้ใช้ หรือโปรไฟล์ของท่านบนแพลตฟอร์ม&nbsp;</p>\n\n<p>(ด) เพื่อดำเนินการเกี่ยวกับข้อร้องเรียน ผลตอบรับ การบังคับใช้และคำร้องขอให้ลบ อันเกี่ยวกับเนื้อหาใดๆ ที่ท่านได้อัพโหลดขึ้นแพลตฟอร์ม</p>\n\n<p>(ต) เพื่อได้รับข้อมูลเพิ่มเติมที่เกี่ยวข้องกับท่าน โดยมีพื้นฐานมาจากข้อมูลส่วนบุคคลที่ท่านได้ให้มา (ไม่ว่าให้กับเราหรือบุคคลภายนอก) เพื่อที่จะให้ข้อมูลกับท่านได้ตรงเป้าและ/หรือเกี่ยวข้องมากขึ้น&nbsp;</p>\n\n<p>(ถ) เราอาจปฎิบัติการประมวลผลการตัดสินใจแบบอัตโนมัติตามวัตถุประสงค์ที่ได้กล่าวไว้ข้างต้น</p>\n\n<p>&nbsp;</p>\n\n<p><strong>4. การถอนความยินยอมที่จะให้ใช้ เปิดเผย เก็บรักษา และ/หรือประมวลผลข้อมูลส่วนบุคคล</strong></p>\n\n<p>4.1 ท่านอาจถอนความยินยอมของท่านที่จะให้ใช้ เปิดเผย เก็บรักษา และ/หรือประมวลผลซึ่งข้อมูลส่วนบุคคลของท่านต่อไปเพื่อวัตถุประสงค์ใด ๆ และในรูปแบบที่ระบุไว้ข้างต้น ไม่ว่าในเวลาใดก็ตาม</p>\n\n<p>4.2 โปรดทราบว่าหากท่านถอนความยินยอมของท่านที่จะให้เราใช้ เปิดเผย เก็บรักษา หรือประมวลผลซึ่งข้อมูลของท่านเพื่อวัตถุประสงค์และในรูปแบบที่ระบุไว้ข้างต้น เราอาจจะไม่อยู่ในฐานะที่จะดำเนินการให้บริการแก่ท่านต่อไปหรือไม่สามารถปฏิบัติตามสัญญาใดที่เรามีกับท่านได้ และเราจะไม่ต้องรับผิดในกรณีที่เราไม่ได้ดำเนินการให้บริการท่านหรือไม่ปฏิบัติตามสัญญากับท่าน</p>\n\n<p>&nbsp;</p>\n\n<p><strong>5. การปรับข้อมูลส่วนบุคคลของท่านให้เป็นปัจจุบัน</strong></p>\n\n<p>5.1 ความถูกต้องและสมบูรณ์ของข้อมูลส่วนบุคคลที่ท่านให้แก่เรานั้นเป็นสิ่งสำคัญเพื่อให้ท่านสามารถใช้แพลตฟอร์มต่อไปได้และให้เราสามารถให้บริการได้ ท่านเป็นผู้รับผิดชอบในการแจ้งเราหากมีการเปลี่ยนแปลงข้อมูลส่วนบุคคลของท่าน หรือในกรณีที่ท่านเชื่อว่าข้อมูลส่วนบุคคลเกี่ยวกับท่านที่อยู่กับเราไม่แม่นยำ ไม่สมบูรณ์ ไม่ถูกต้องหรือล้าสมัย&nbsp;</p>\n\n<p>5.2 ท่านสามารถแก้ไขข้อมูลส่วนบุคคลของท่านให้เป็นปัจจุบันได้ไม่ว่าในเวลาใดโดยการเข้าถึงซึ่งบัญชีผู้ใช้ของท่านบนแพลตฟอร์ม</p>\n\n<p>5.3 เรามีการเปิดเผยข้อมูลส่วนบุคคลที่ได้แก้ไขเป็นปัจจุบันของท่านแก่บุคคลภายนอกและบริษัทในเครือของเราผู้ซึ่งเราได้เคยเปิดเผยข้อมูลส่วนบุคคลของท่านแล้ว หากข้อมูลส่วนบุคคลของท่านนั้นยังมีความจำเป็นในการดำเนินการตามวัตถุประสงค์ที่ระบุไว้ข้างต้น</p>\n\n<p>&nbsp;</p>\n\n<p><strong>6. ความปลอดภัยของข้อมูลส่วนบุคคลของท่าน</strong></p>\n\n<p>6.1 เพื่อรักษาความปลอดภัยซึ่งข้อมูลส่วนบุคคลของท่านจากการเข้าถึง การเก็บรวบรวม การใช้ การเปิดเผย การประมวลผล การทำสำเนา การเปลี่ยนแปลง การจำหน่าย การทำให้สูญหาย การใช้ในทางที่ผิด การดัดแปลงหรือความเสี่ยงอื่นที่คล้ายคลึงกัน โดยไม่ได้รับอนุญาต เราได้ใช้มาตรการในการจัดการที่เหมาะสม ทั้งที่เป็นรูปธรรมและในทางเทคนิค เช่น&nbsp;</p>\n\n<p>(ก) จำกัดสิทธิการเข้าถึงข้อมูลส่วนบุคคลให้เข้าถึงได้เฉพาะของบุคคลที่จำเป็นต้องเข้าถึง</p>\n\n<p>(ข) รักษาระดับของผลิตภัณฑ์ที่เกี่ยวข้องกับเทคโนโลยีเพื่อป้องกันการเข้าถึงทางคอมพิวเตอร์ที่ไม่ได้รับอนุญาต และ&nbsp;</p>\n\n<p>6.2 หากท่านเชื่อว่าความเป็นส่วนตัวของท่านถูกละเมิด กรุณาติดต่อเราโดยทันที&nbsp;</p>\n\n<p>6.3 ท่านควรทราบว่าไม่มีวิธีการถ่ายโอนใดบนอินเตอร์เน็ตหรือขั้นตอนการเก็บข้อมูลทางอิเล็กทรอนิกส์ใดที่ปลอดภัยโดยสมบูรณ์ แม้ไม่สามารถรับประกันความปลอดภัยนั้นได้ แต่เราได้พยายามอย่างมากที่จะปกป้องความปลอดภัยในข้อมูลของท่านและจะทบทวนและเพิ่มเติมมาตรการการรักษาข้อมูลอย่างสม่ำเสมอ&nbsp;</p>\n\n<p>6.4 รหัสผ่านของท่านคือกุญแจในการเข้าถึงบัญชีของท่าน กรุณาใช้ตัวเลขเฉพาะ ตัวอักษรและอักษรพิเศษ และจะต้องไม่แบ่งปันรหัสผ่านของท่านกับบุคคลใด หากท่านแบ่งปันรหัสของท่านกับผู้อื่น ท่านจะต้องรับผิดชอบการกระทำทั้งหมดที่ได้ทำไปในนามของบัญชีของท่านและผลที่ตามมา หากท่านเสียการควบคุมรหัสผ่านของท่าน ท่านอาจเสียการควบคุมข้อมูลส่วนบุคคลของท่านและข้อมูลอื่นที่ท่านได้ส่งให้แก่ลาซาด้าอย่างมีนัยสำคัญ รวมทั้งท่านอาจตกอยู่ภายใต้ความผูกพันตามกฎหมายในการกระทำใด ๆ ที่ได้กระทำไปในนามของท่าน ดังนั้นหากมีการเข้าถึงรหัสของท่านโดยไม่ได้รับอนุญาตไม่ว่าด้วยเหตุใดหรือมีเหตุอันควรเชื่อว่ารหัสของท่านถูกเข้าถึงโดยไม่ได้รับอนุญาต ท่านควรติดต่อเราและเปลี่ยนรหัสของท่านโดยทันที ท่านจะต้องไม่ลืมออกจากระบบบัญชีของท่าน</p>\n\n<p>&nbsp;</p>\n\n<p><strong>8. การเก็บรักษาข้อมูลส่วนบุคคล</strong></p>\n\n<p>8.1 เราจะเก็บรักษาข้อมูลส่วนบุคคลของท่านไว้เพียงเท่าที่กฎหมายกำหนดไว้หรือเท่าที่จำเป็นสำหรับวัตถุประสงค์ของการเก็บข้อมูลดังกล่าว</p>\n\n<p>8.2 เราจะยุติการเก็บรักษาข้อมูลส่วนบุคคลของท่านหรือนำวิธีการที่ข้อมูลที่อาจเชื่อมโยงกับท่านออก โดยทันทีที่เห็นสมควรแล้วว่าการเก็บรักษานั้น ไม่สามารถบรรลุวัตถุประสงค์ที่ข้อมูลส่วนบุคคลดังกล่าวได้ถูกเก็บรวบรวมมาแล้วอีกต่อไป และไม่มีความจำเป็นสำหรับวัตถุประสงค์ทางกฎหมายหรือทางธุรกิจใด</p>\n\n<p>&nbsp;</p>\n\n<p><strong>9. การเก็บรวบรวมข้อมูลคอมพิวเตอร์</strong></p>\n\n<p>9.1 เราหรือผู้ให้บริการที่ได้รับอนุญาตจากเราอาจใช้ คุกกี้ เว็บ บีคอนและเทคโนโลยีอื่นใดที่คล้ายคลึงกันเพื่อเก็บรักษาข้อมูลที่ช่วยให้เราสร้างประสบการณ์เฉพาะตัวที่ดีขึ้น เร็วขึ้น ปลอดภัยขึ้นเมื่อท่านใช้บริการหรือเข้าถึงแพลตฟอร์ม&nbsp;</p>\n\n<p>9.2 เมื่อท่านเข้าชมแพลตฟอร์มผ่านคอมพิวเตอร์ อุปกรณ์เคลื่อนที่ หรืออุปกรณ์อื่นใดที่มีการเชื่อมต่ออินเตอร์เน็ตของท่าน เซิร์ฟเวอร์ของบริษัทเราจะบันทึกข้อมูลที่บราวเซอร์ของท่านได้ส่งมาโดยอัตโนมัติเมื่อได้เข้าสู่เว็ปไซต์ โดยข้อมูลอาจรวมถึง&nbsp;</p>\n\n<p>(ก) หมายเลขไอพีของคอมพิวเตอร์หรืออุปกรณ์ของท่าน&nbsp;</p>\n\n<p>(ข) ชนิดของบราวเซอร์</p>\n\n<p>(ค) เว็บเพจที่ท่านเข้าชมก่อนที่ท่านจะเข้าถึงแพลตฟอร์ม&nbsp;</p>\n\n<p>(ง) หน้าในแพลตฟอร์มที่ท่านเข้าชม และ&nbsp;</p>\n\n<p>(จ) ระยะเวลาที่ท่านใช้บนหน้าดังกล่าว สิ่งของและข้อมูลที่ท่านค้นหาบนแพลตฟอร์ม ระยะเวลาเข้าถึงและวันที่และสถิติอื่น ๆ&nbsp;</p>\n\n<p>9.3 ข้อมูลเหล่านี้จะถูกเก็บรวบรวมเพื่อวิเคราะห์และประเมินเพื่อที่จะช่วยเราปรับปรุงเว็ปไซต์และการบริการและสินค้าที่เรามี&nbsp;</p>\n\n<p>9.4 คุกกี้คือไฟล์ตัวอักษรขนาดเล็ก (ปกติแล้วจะประกอบด้วยตัวอักษรและตัวเลข) ที่ตั้งอยู่ในความจำของบราวเซอร์หรืออุปกรณ์ของท่านเมื่อท่านเข้าชมเวปไซต์หรือดูข้อความ คุกกี้ทำให้เราสามารถจำอุปกรณ์หรือบราวเซอร์ดังกล่าวและช่วยให้เราสามารถทำเนื้อหาให้เป็นการเฉพาะโดยให้เหมาะสมกับสิ่งที่ท่านสนใจได้รวดเร็วขึ้นและจะทำให้การบริการและแพลตฟอร์มมีความสะดวกสบายและมีประโยชน์กับท่าน&nbsp;</p>\n\n<p>&nbsp;</p>\n\n<p><strong>10. เว็บไซต์ของบุคคลภายนอก</strong></p>\n\n<p>10.1 แพลตฟอร์มอาจมีลิงก์ที่นำไปสู่เว็บไซต์อื่นที่ดำเนินการโดยฝ่ายอื่น เช่น ผู้เกี่ยวข้องกับเราทางธุรกิจ พ่อค้า หรือช่องทางการชำระเงิน เราจะไม่รับผิดชอบในวิธีปฎิบัติเกี่ยวกับความเป็นส่วนตัวของเว็บไซต์ที่ดำเนินการโดยฝ่ายอื่นดังกล่าว ขอแนะนำท่านให้ตรวจสอบนโยบายความเป็นส่วนตัวที่เกี่ยวข้องในเว็บไซต์ดังกล่าวเพื่อที่จะทราบว่าเว็บไซต์ดังกล่าวจะจัดการกับข้อมูลที่ได้เก็บรวบรวมไปจากท่านอย่างไร</p>\n\n<p>&nbsp;</p>\n\n<hr />\n<p><br />\n<span style=\"font-size:14px\">ปรับปรุงครั้งล่าสุดวันที่ 16&nbsp;เมษายน 2563</span></p>\n\n<p>&nbsp;</p>\n\n<p>&nbsp;</p>\n');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='ที่อยู่สมาชิก';
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='หมวดสินค้า';
...
INSERT IGNORE INTO `contact` (`id`, `tel`, `email`, `address`) VALUES
(1, '089-5266265', 'contact@jehmuaymarket.com', '-');
...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บข้อมูล';
...
(1, 1, 'user ID 1 Confirm Order 7', 7, '2020-04-14 04:34:25', 4, NULL),
(2, NULL, 'user ID 27 CheckOut 8', NULL, '2020-04-14 09:43:18', 1, 27),
(3, 1, 'user ID 1 Confirm Order 8', 8, '2020-04-14 09:43:29', 4, NULL),
(4, NULL, 'user ID 30 CheckOut 9', NULL, '2020-04-15 18:25:09', 1, 30),
(5, NULL, 'user ID 27 CheckOut 10', NULL, '2020-04-16 09:04:38', 1, 27),
(6, 1, 'user ID 1 Confirm Order 9', 9, '2020-04-16 09:13:04', 4, NULL);
...
CREATE TABLE IF NOT EXISTS `logproduct` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='เก็บข้อมูลการจัดการสินค้า';
...
(1, 'user1 | login', 'admin', '2020-04-09 16:18:58', '::1', 'TRUE'),
(2, '!LoginFail | login', '', '2020-04-09 16:20:17', '::1', 'FALSE'),
(3, 'user1 | login', 'admin', '2020-04-09 16:20:22', '::1', 'TRUE'),
(4, '!LoginFail | login', '', '2020-04-09 16:21:17', '::1', 'FALSE'),
(5, 'user1 | login', 'admin', '2020-04-09 16:26:25', '::1', 'TRUE'),
(6, 'user1 | login', 'admin', '2020-04-10 04:08:34', '::1', 'TRUE'),
(7, 'user1 | login', 'admin', '2020-04-10 07:11:36', '::1', 'TRUE'),
(8, 'user29 | login', 'user', '2020-04-10 07:16:33', '::1', 'TRUE'),
(9, 'user29 | login', 'user', '2020-04-10 07:18:55', '::1', 'TRUE'),
(10, 'user29 | login', 'user', '2020-04-10 07:27:56', '::1', 'TRUE'),
(11, 'user29 | login', 'user', '2020-04-10 07:28:00', '::1', 'TRUE'),
(12, 'user29 | login', 'user', '2020-04-10 07:28:02', '::1', 'TRUE'),
(13, 'user29 | login', 'user', '2020-04-10 07:28:04', '::1', 'TRUE'),
(14, 'user29 | login', 'user', '2020-04-10 07:28:07', '::1', 'TRUE'),
(15, 'user29 | login', 'user', '2020-04-10 07:29:01', '::1', 'TRUE'),
(16, 'user29 | login', 'user', '2020-04-10 07:29:04', '::1', 'TRUE'),
(17, 'user29 | login', 'user', '2020-04-10 07:30:09', '::1', 'TRUE'),
(18, 'user29 | login', 'user', '2020-04-10 07:30:11', '::1', 'TRUE'),
(19, 'user29 | login', 'user', '2020-04-10 07:30:44', '::1', 'TRUE'),
(20, 'user29 | login', 'user', '2020-04-10 07:31:19', '::1', 'TRUE'),
(21, 'user27 | login', 'demo', '2020-04-10 07:31:38', '::1', 'TRUE'),
(22, 'user27 | login', 'demo', '2020-04-10 07:32:01', '::1', 'TRUE'),
(23, 'user1 | login', 'admin', '2020-04-10 07:32:13', '::1', 'TRUE'),
(24, 'user1 | login', 'admin', '2020-04-10 07:38:06', '::1', 'TRUE'),
(25, 'user29 | login', 'user', '2020-04-10 07:38:14', '::1', 'TRUE'),
(26, 'user29 | login', 'user', '2020-04-10 08:35:59', '::1', 'TRUE'),
(27, 'user1 | login', 'admin', '2020-04-10 19:04:49', '::1', 'TRUE'),
(28, 'user27 | login', 'demo', '2020-04-11 06:20:35', '::1', 'TRUE'),
(29, '!LoginFail | login', '', '2020-04-11 19:30:01', '::1', 'FALSE'),
(30, 'user30 | login', 'kimniyom', '2020-04-11 19:45:21', '::1', 'TRUE'),
(31, 'user27 | login', 'demo', '2020-04-12 05:45:22', '::1', 'TRUE'),
(32, '!LoginFail | login', '', '2020-04-12 15:34:08', '::1', 'FALSE'),
(33, '!LoginFail | login', '', '2020-04-12 15:34:11', '::1', 'FALSE'),
(34, '!LoginFail | login', '', '2020-04-12 15:34:14', '::1', 'FALSE'),
(35, 'user31 | login', 'user1', '2020-04-12 16:41:58', '::1', 'TRUE'),
(36, 'user31 | login', 'user1', '2020-04-12 17:23:42', '::1', 'TRUE'),
(37, 'user27 | login', 'demo', '2020-04-13 17:04:32', '::1', 'TRUE'),
(38, 'user1 | login', 'admin', '2020-04-14 03:50:33', '::1', 'TRUE'),
(39, 'user1 | login', 'admin', '2020-04-14 08:48:11', '::1', 'TRUE'),
(40, 'user27 | login', 'demo', '2020-04-14 09:43:08', '::1', 'TRUE'),
(41, 'user1 | login', 'admin', '2020-04-14 09:55:07', '61.7.129.105', 'TRUE'),
(42, '!LoginFail | login', '', '2020-04-14 10:08:58', '182.232.235.138', 'FALSE'),
(43, '!LoginFail | login', '', '2020-04-14 10:10:15', '182.232.235.138', 'FALSE'),
(44, 'user27 | login', 'demo', '2020-04-14 19:42:08', '61.7.129.105', 'TRUE'),
(45, '!LoginFail | login', '', '2020-04-14 19:59:47', '182.232.235.146', 'FALSE'),
(46, 'user27 | login', 'demo', '2020-04-14 20:02:05', '182.232.235.146', 'TRUE'),
(47, '!LoginFail | login', '', '2020-04-15 08:00:41', '17.57.26.176', 'FALSE'),
(48, '!LoginFail | login', '', '2020-04-15 08:00:45', '17.57.26.176', 'FALSE'),
(49, '!LoginFail | login', '', '2020-04-15 08:01:10', '17.57.26.176', 'FALSE'),
(50, '!LoginFail | login', '', '2020-04-15 08:01:18', '17.57.26.176', 'FALSE'),
(51, 'user1 | login', 'admin', '2020-04-15 08:22:32', '116.58.228.89', 'TRUE'),
(52, 'user1 | login', 'admin', '2020-04-15 08:26:45', '116.58.228.89', 'TRUE'),
(53, '!LoginFail | login', '', '2020-04-15 08:47:39', '182.232.241.118', 'FALSE'),
(54, 'user1 | login', 'admin', '2020-04-15 08:47:46', '182.232.241.118', 'TRUE'),
(55, 'user27 | login', 'demo', '2020-04-15 08:47:59', '182.232.241.118', 'TRUE'),
(56, '!LoginFail | login', '', '2020-04-15 14:43:16', '17.57.24.57', 'FALSE'),
(57, '!LoginFail | login', '', '2020-04-15 14:43:23', '17.57.24.57', 'FALSE'),
(58, 'user27 | login', 'demo', '2020-04-15 14:43:23', '17.57.24.57', 'TRUE'),
(59, '!LoginFail | login', '', '2020-04-15 14:45:01', '17.56.152.147', 'FALSE'),
(60, '!LoginFail | login', '', '2020-04-15 14:45:07', '182.232.241.118', 'FALSE'),
(61, '!LoginFail | login', '', '2020-04-15 14:45:54', '17.56.152.147', 'FALSE'),
(62, 'user27 | login', 'demo', '2020-04-15 14:45:55', '182.232.241.118', 'TRUE'),
(63, 'user27 | login', 'demo', '2020-04-15 15:37:12', '17.235.79.226', 'TRUE'),
(64, 'user1 | login', 'admin', '2020-04-15 16:38:36', '116.58.228.89', 'TRUE'),
(65, 'user1 | login', 'admin', '2020-04-15 16:54:19', '116.58.228.89', 'TRUE'),
(66, 'user1 | login', 'admin', '2020-04-15 18:15:00', '116.58.228.89', 'TRUE'),
(67, 'user30 | login', 'kimniyom', '2020-04-15 18:22:54', '182.232.241.118', 'TRUE'),
(68, 'user1 | login', 'admin', '2020-04-16 02:20:08', '116.58.228.89', 'TRUE'),
(69, 'user27 | login', 'demo', '2020-04-16 04:09:03', '116.58.228.89', 'TRUE'),
(70, '!LoginFail | login', '', '2020-04-16 04:53:13', '182.232.243.14', 'FALSE'),
(71, 'user1 | login', 'admin', '2020-04-16 05:17:28', '182.232.243.14', 'TRUE'),
(72, 'user1 | login', 'admin', '2020-04-16 05:38:46', '182.232.243.14', 'TRUE'),
(73, 'user1 | login', 'admin', '2020-04-16 05:52:29', '182.232.243.14', 'TRUE'),
(74, 'user1 | login', 'admin', '2020-04-16 06:27:01', '110.77.175.125', 'TRUE'),
(75, 'user27 | login', 'demo', '2020-04-16 08:10:40', '110.77.175.125', 'TRUE'),
(76, '!LoginFail | login', '', '2020-04-16 08:30:20', '110.77.175.125', 'FALSE'),
(77, '!LoginFail | login', '', '2020-04-16 08:31:30', '182.232.243.14', 'FALSE'),
(78, '!LoginFail | login', '', '2020-04-16 08:36:20', '17.56.154.74', 'FALSE'),
(79, '!LoginFail | login', '', '2020-04-16 08:36:27', '17.56.154.74', 'FALSE'),
(80, '!LoginFail | login', '', '2020-04-16 08:36:41', '17.56.154.74', 'FALSE'),
(81, '!LoginFail | login', '', '2020-04-16 08:36:47', '17.56.154.74', 'FALSE'),
(82, '!LoginFail | login', '', '2020-04-16 08:36:54', '17.56.154.74', 'FALSE'),
(83, '!LoginFail | login', '', '2020-04-16 08:36:57', '17.56.153.47', 'FALSE'),
(84, '!LoginFail | login', '', '2020-04-16 08:37:55', '17.56.153.47', 'FALSE'),
(85, 'user27 | login', 'demo', '2020-04-16 08:50:13', '182.232.243.14', 'TRUE'),
(86, 'user1 | login', 'admin', '2020-04-16 08:57:51', '110.77.175.125', 'TRUE'),
(87, 'user1 | login', 'admin', '2020-04-16 09:12:39', '49.229.165.164', 'TRUE'),
(88, '!LoginFail | login', '', '2020-04-16 09:30:23', '110.77.175.125', 'FALSE'),
(89, '!LoginFail | login', '', '2020-04-16 09:30:25', '110.77.175.125', 'FALSE'),
(90, '!LoginFail | login', '', '2020-04-16 09:30:26', '110.77.175.125', 'FALSE'),
(91, '!LoginFail | login', '', '2020-04-16 09:30:27', '110.77.175.125', 'FALSE'),
(92, '!LoginFail | login', '', '2020-04-16 09:30:27', '110.77.175.125', 'FALSE'),
(93, '!LoginFail | login', '', '2020-04-16 09:30:27', '110.77.175.125', 'FALSE'),
(94, '!LoginFail | login', '', '2020-04-16 09:30:27', '110.77.175.125', 'FALSE'),
(95, '!LoginFail | login', '', '2020-04-16 09:30:34', '110.77.175.125', 'FALSE'),
(96, '!LoginFail | login', '', '2020-04-16 10:28:35', '182.232.243.14', 'FALSE'),
(97, '!LoginFail | login', '', '2020-04-16 14:31:20', '110.77.175.125', 'FALSE'),
(98, 'user27 | login', 'demo', '2020-04-16 14:31:29', '110.77.175.125', 'TRUE'),
(99, '!LoginFail | login', '', '2020-04-16 14:42:42', '182.232.243.14', 'FALSE');
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='ตารางสมาชิก';
...
(30, NULL, '', 'ทรงพล', 'คำสะอสด', NULL, 'f95258a9a4921f303be3b3e662114a36', 'kimniyomclub@gmail.com', '0821684717', 'M', NULL, 'U', NULL, NULL, NULL, 'kimniyom', NULL),
...
(32, NULL, '', 'kimniyom', 'Pdk', NULL, 'f95258a9a4921f303be3b3e662114a36', 'kimniyomclub@gmail.com', '0821684717', NULL, NULL, 'U', NULL, NULL, NULL, 'kimniyom', NULL);
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `user` int(10) DEFAULT NULL,
  `codesend` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'รหัสจัดส่ง',
  PRIMARY KEY (`id`)
...
INSERT IGNORE INTO `orders` (`id`, `order_date`, `order_fullname`, `order_address`, `order_phone`, `order_email`, `order_msg`, `order_confirm`, `admin_id`, `order_confirm_date`, `slip`, `user`, `codesend`) VALUES
(1, '2020-04-11 15:42:42', 'ทรงพล คำสะอาด', '165 ม. 7 ต.ไม้งาม อ.เมือง จ.ตาก 63000', '0821684717', 'kimniyomclub@gmail.com', NULL, 0, NULL, NULL, NULL, NULL, NULL),
(2, '2020-04-14 00:05:33', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 0, NULL, NULL, NULL, NULL, NULL),
(3, '2020-04-14 01:02:24', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 0, NULL, NULL, NULL, NULL, NULL),
(4, '2020-04-14 01:03:41', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 0, NULL, NULL, NULL, NULL, NULL),
(5, '2020-04-14 01:08:46', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 0, NULL, NULL, NULL, NULL, NULL),
(6, '2020-04-14 01:10:03', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 0, NULL, NULL, NULL, NULL, NULL),
(7, '2020-04-14 01:17:57', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 4, 1, '2020-04-14 04:34:25', '158680187792356242_612391026157306_6742025574320963584_n.jpg', 27, NULL),
(8, '2020-04-14 16:43:18', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 4, 1, '2020-04-14 09:43:29', '1586857398BBL.jpg', 27, NULL),
(9, '2020-04-16 01:25:09', 'ทรงพล คำสะอสด', '165 ม 7  ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0821684717', 'kimniyomclub@gmail.com', NULL, 4, 1, '2020-04-16 09:13:04', '1586975109A08EFBDC-CA86-4D55-B7FA-1C7515FB6D87.png', 30, NULL),
(10, '2020-04-16 16:04:38', 'demo demo', '165 ม.7 สำนักงานสาธารณสุข ห้อง(IT) ต.ไม้งาม    อ.เมืองตาก    จ.ตาก    63000', '0800249484', 'demo1@gmail.com', NULL, 1, NULL, NULL, '1587027878CB031E3D-9D5A-4693-9612-73F1CCADC7B7.jpeg', 27, NULL);
...
(1, 1, '31.50', 'P20181223184138', 1),
(2, 50, '35.00', 'P20200409233255', 1),
(3, 1, '35.00', 'P20200409233255', 2),
(4, 1, '31.50', 'P20181223184138', 3),
(5, 2, '35.00', 'P20200409233255', 3),
(6, 1, '35.00', 'P20200409233255', 4),
(7, 1, '35.00', 'P20200409233255', 5),
(8, 1, '35.00', 'P20200409233255', 6),
(9, 2, '35.00', 'P20200409233255', 7),
(10, 1, '35.00', 'P20200409233255', 8),
(11, 1, '31.50', 'P20181223184138', 9),
(12, 1, '35.00', 'P20200409233255', 10);
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  UNIQUE KEY `id` (`id`) USING BTREE,
  KEY `type_id` (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='ตารางสินค้า';
...
INSERT IGNORE INTO `product` (`id`, `product_id`, `product_name`, `product_price`, `product_detail`, `product_num`, `type_id`, `delete_flag`, `status`, `category`, `brand`, `recommend`, `d_update`, `description`, `product_price_pro`, `bastseller`, `countread`) VALUES
(12, 'P20181223184138', 'ยำยำ จัมโบ้ ', '31.50', '<p style=\"margin-left:0px; margin-right:0px; text-align:start\">ยำยำ จัมโบ้</p>\n\n<p style=\"margin-left:0px; margin-right:0px; text-align:start\">บะหมี่กึ่งสำเร็จรูป รสต้มยำทะเลหม้อไฟ 67กรัม x 6 ซอง</p>\n', NULL, '001', 0, 0, 1, 0, NULL, '2020-04-09 23:55:34', 'ยำยำ จัมโบ้ บะหมี่กึ่งสำเร็จรูป รสต้มยำทะเลหม้อไฟ 67กรัม x 6 ซอง', '0.00', 0, 50),
(21, 'P20200409233255', 'มาม่า คัพ', '35.00', '<p><strong>มาม่า คัพ&nbsp;</strong></p>\n\n<p>มาม่า คัพ บะหมี่กึ่งสำเร็จรูป รสต้มยำกุ้ง 60กรัม x 3 ถ้วย</p>\n', NULL, '001', 0, 0, 1, 0, NULL, '2020-04-15 15:42:39', 'มาม่า คัพ บะหมี่กึ่งสำเร็จรูป รสต้มยำกุ้ง 60กรัม x 3 ถ้วย', '0.00', 0, 89);
...
CREATE TABLE IF NOT EXISTS `product_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='ตารางเก็บรูปภาพสินค้า';
...
CREATE TABLE IF NOT EXISTS `product_type` (
  ...
  UNIQUE KEY `id` (`id`) USING BTREE,
  KEY `type_id` (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='ตารางประเภทสินค้า';
...
CREATE TABLE IF NOT EXISTS `viewproduct` (
  ...
  `dupdate` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=421 DEFAULT CHARSET=utf8 COMMENT='เก้บประวัติการเข้าดูสินค้า';
